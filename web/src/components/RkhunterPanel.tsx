  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-start gap-2 bg-yellow-50 dark:bg-yellow-950 border border-yellow-300 dark:border-yellow-800 px-3 py-2 rounded text-xs text-yellow-800 dark:text-yellow-200">
        ...
        <span>
          Esse scan pode levar <strong>3-10 minutos</strong> dependendo do host.
          Pode fechar essa aba — o badge atualiza sozinho quando completa.
        </span>
      </div>
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <ScanProgressBadge hostId={hostId} actionType="run_rkhunter_scan" label="Último:" />
      </div>
